...
class CompLamp:
    ...
    def __init__ (self , parent , width , order , coler="red" , *args , **kwargs):
    ...
    def turn_off(self):
        self.state = "off"        
        self.canvas.itemconfigure(self.lamp , fill="balck")
